...
# Limites 1DOF connues sur 8+/1x (STATE.md, ROADMAP « Piste différée »).
# Pas un assouplissement de seuil — xfail documenté si hors bande.
KNOWN_ETA_GAP_CLASSES = frozenset({"8+", "1x"})  # η≈0,62
KNOWN_CF_GAP_CLASSES = frozenset({"8+", "1x"})  # cf≈3,1 — empilement CdM×Hermite²
